class ProductsController < ApplicationController
  ...
  def index
    ...
    @products = Product.all.where(shop_owner: false, approved: true, user_id: [staff_ids, nil]).order(id: :desc)
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :weight, :length, :vendor, :is_bundle,
                                      ...
                                      :price, :cost, :product_url, :suggest_price, :purchase_link, :china_name)
    end
